...
from account.serializers import OBJProvince,OBJCity
from .models import City, Province, User
...
class ApiProvinceList(LoginRequiredMixin,ListCreateAPIView):
    queryset = Province.objects.all()
    serializer_class = OBJProvince

class ApiCityList(LoginRequiredMixin,ListCreateAPIView):
	serializer_class = OBJCity
	...
	def get_queryset(self):
		...
		if IdProvince == 0:
			...
			return City.objects.filter(IdProvince=IdProvince)