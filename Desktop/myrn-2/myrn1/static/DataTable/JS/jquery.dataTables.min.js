...
fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"اولین",sLast:"آخرین",
sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"داده ای جهت نمایش وجود ندارد",sInfo:"نمایش _START_ تا _END_ از مجموع _TOTAL_ سطر داده    ",sInfoEmpty:"نمایش 0 تا 0 از 0 کل",sInfoFiltered:"(فیلتر شده از _MAX_ مجموع کل)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_  رکوردی ",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"جستجو : ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"برطبق فیلتر شما موردی یافت نشد"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
