...
class APIStoreroomCreate(StorekeeperUserAccessMixin,ListCreateAPIView):
    queryset = Storeroom.objects.all()
    serializer_class = Storeroomserializer

class APIUnitofMeasurementCreate(StorekeeperUserAccessMixin,ListCreateAPIView):
    queryset = UnitofMeasurement.objects.all()
    serializer_class = UnitofMeasurementserializer

class APIGroupCommodityCreate(StorekeeperUserAccessMixin,ListCreateAPIView):
    queryset = GroupCommodity.objects.all()
    serializer_class = GroupCommodityserializer

class APICategoryCommodityCreate(StorekeeperUserAccessMixin,ListCreateAPIView):
    queryset = CategoryCommodity.objects.all()
    serializer_class = CategoryCommodityserializer

class APIUnitPackCreate(StorekeeperUserAccessMixin,ListCreateAPIView):
    queryset = UnitPack.objects.all()
    serializer_class = UnitPackserializer

class APISupplierCreate(StorekeeperUserAccessMixin,ListCreateAPIView):
    queryset = Supplier.objects.all()
    serializer_class = Supplierserializer

class APICommodityCreate(StorekeeperUserAccessMixin,ListCreateAPIView):
