...
from extensions.utils import jalali_converterWT
...
class Storeroom(models.Model):
    ...
    Telephone = models.CharField(verbose_name="شماره تلفن",max_length=10,null=True,blank=True)#شماره تلفن
...
class Customer(models.Model):
    ...
    Name = models.CharField(verbose_name="نام",max_length=200,null=True,blank=True)#نام
    Family = models.CharField(verbose_name="نام خانوادگی",max_length=200)#نام خانوادگی
    Mobile = models.CharField(verbose_name="شماره موبایل",max_length=10,null=True,blank=True)#شماره موبایل
    TelephoneCustomer = models.CharField(verbose_name="شماره تلفن",max_length=15)#شماره تلفن
    RegistrationNumber = models.CharField(verbose_name="شماره ثبت",max_length=20,null=True,blank=True)#شماره ثبت
    EconomicNumber = models.CharField(verbose_name="کدملی/شماره اقتصادی",max_length=20,null=True,blank=True)#کدملی/شماره اقتصادی
    NationalID = models.CharField(verbose_name="شناسه ملی",max_length=20,null=True,blank=True)#شناسه ملی
    PostalCode = models.CharField(verbose_name="کد پستی",max_length=10,null=True,blank=True)#کد پستی
    Address = models.TextField(verbose_name="آدرس",null=True,blank=True)#آدرس
    FirstBalanceCourse = models.IntegerField(verbose_name="مانده اول دوره",default=0)#مانده اول دوره
...
class drivers(models.Model):
    ...
    Name = models.CharField(verbose_name="نام",max_length=100,null=True,blank=True)
    ...
    FreightName = models.CharField(verbose_name="نام باربری",max_length=200,null=True,blank=True)
    AccountNumber = models.CharField(verbose_name="شماره حساب",max_length=20,null=True,blank=True) 
    Shabanumber = models.CharField(verbose_name="شماره شبا",max_length=24) 
    CardNumber = models.CharField(verbose_name="شماره کارت",max_length=16,null=True,blank=True) 
    Address = models.CharField(verbose_name="آدرس",max_length=200,null=True,blank=True)
...
class Commodity(models.Model):
    ...
    OrderPoint = models.IntegerField(verbose_name="نقطه سفارش",null=True,blank=True) # نقطه سفارش
    MinimumInventory= models.IntegerField(verbose_name="حداقل موجودی",null=True,blank=True)# حداقل موجودی
    OrderAmount = models.IntegerField(verbose_name="میزان سفارش",null=True,blank=True)# میزان سفارش
    MaximumInventory= models.IntegerField(verbose_name="حداکثر موجودی",null=True,blank=True)# حداکثر موجودی
    AddressCommodity = models.TextField(verbose_name="آدرس کالا",null=True,blank=True)# آدرس کالا
    TechnicalNumber =  models.CharField(verbose_name="شماره فنی",max_length=100,null=True,blank=True)# شماره فنی
    BarCodeText = models.CharField(verbose_name="بارکد",max_length=255,null=True,blank=True)#بارکدمتن
    BarCodeImage = models.CharField(verbose_name="بارکد",max_length=255,null=True,blank=True)#بارکدمتن
    TechnicalSpecifications = models.TextField(verbose_name="مشخصات فنی",null=True,blank=True)# مشخصات فنی
    ...
    Description = models.TextField(verbose_name="توضیحات",null=True,blank=True)#توضیحات
    ...
    def jEntryDateTime(self):
        return jalali_converterWT(self.EntryDateTime)
...
class EntryCommodity(models.Model):
    ...
    Serial = models.CharField(max_length=200,verbose_name="سریال کالا",null=True,blank=True)#سریال کالا
    ...
    def jDateExpired(self):
        return jalali_converterWT(self.DateExpired)
    jDateExpired.short_description = "تاریخ انقضا"

    def MDateExpired(self):
        return str(self.DateExpired.year) + "-" + str(self.DateExpired.month) + "-" + str(self.DateExpired.day)

    def jDateEntry(self):
        return jalali_converterWT(self.DateEntry)
    jDateEntry.short_description = "تاریخ ورود کالا"

    def MDateEntry(self):
        return str(self.DateEntry.year) + "-" + str(self.DateEntry.month) + "-" + str(self.DateEntry.day)
...
class Transportation(models.Model):
    ...
    FreightNumber = models.IntegerField(verbose_name="شماره بارنامه",null=True,blank=True)# شماره بارنامه
    SourceAddress = models.CharField(max_length=200,verbose_name="آدرس مبدا",null=True,blank=True)#آدرس مبدا
    ...
    def jDate(self):
        return jalali_converterWT(self.Date)
...
class productRepaired(models.Model):
    ...
    IdCommodity = models.ForeignKey(Commodity,on_delete=models.CASCADE,verbose_name="نام کالا")# نام کالا 
    IdCustomer = models.ForeignKey(Customer,on_delete=models.CASCADE,verbose_name="نام مشتری")#نام مشتری 
    SerialNumber = models.CharField(max_length=200,verbose_name="سریال کالا",null=True,blank=True) #شماره سریال 
    ...
    Description = models.TextField(verbose_name="توضیحات",max_length=200,null=True,blank=True)#توضیحات
    Status = models.CharField(default='N',max_length=1, choices=STATUS_CHOICES, verbose_name="وضعیت")

    def jDateDelivery(self):
        return jalali_converterWT(self.DateDelivery)
    jDateDelivery.short_description = "تاریخ تحویل"

    def MDateDelivery(self):
        return str(self.DateDelivery.year) + "-" + str(self.DateDelivery.month) + "-" + str(self.DateDelivery.day)

    def jDateRegistration(self):
        return jalali_converterWT(self.DateRegistration)
...
class Receipt(models.Model):
    ...
    Taxation = models.IntegerField(verbose_name="مالیات",default=0)# مالیات 
...
class SettlementArrived(models.Model):
    ...
    Description = models.TextField(verbose_name="توضیحات",max_length=200,null=True,blank=True)# توضیحات
    Address = models.CharField(verbose_name="آدرس",max_length=200,null=True,blank=True)# آدرس
    Telephone = models.CharField(verbose_name="تلفن",max_length=10)# تلفن
    ReceiptNumber = models.CharField(max_length=20, verbose_name="شماره سند",null=True,blank=True) #شماره سند
...
class PurchaseRequest(models.Model):
    ...
    IdUnitofMeasurement = models.ForeignKey(UnitofMeasurement,on_delete=models.CASCADE,verbose_name="واحد سنجش")# واحد کالا 
    Count = models.IntegerField(verbose_name="تعداد")# تعداد 
    DateRequired = models.DateTimeField(verbose_name="تاریخ نیاز",null=True,blank=True)# تاریخ نیاز
    Date = models.DateTimeField(auto_now=True,verbose_name="تاریخ ثبت")# تاریخ ثبت
    IdStoreroom = models.ForeignKey(Storeroom,on_delete=models.CASCADE,verbose_name="نام انبار")# نام انبار )
    TechnicalSpecifications = models.TextField(verbose_name="مشخصات فنی",max_length=200,null=True,blank=True)# مشخصات فنی
    PurchaseSource = models.CharField(max_length=20, verbose_name="منبع خرید",null=True,blank=True) #منبع خرید
    PurchasingOfficer = models.CharField(max_length=20, verbose_name="مامور خرید",null=True,blank=True) #مامور خرید
    ...
    def jDateRequired(self):
        return jalali_converterWT(self.DateRequired)
    jDate.short_description = "تاریخ نیاز"

    def MDateRequired(self):
        return str(self.DateRequired.year) + "-" + str(self.DateRequired.month) + "-" + str(self.DateRequired.day)
