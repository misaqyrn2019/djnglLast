...
@register.simple_tag
def title():
    return "برنامه ریزی منابع سازمانی"
...
def link(request,area, link_name, content, classes):
	return {
		"request": request,
		"link_name": link_name,
		"link": "{}:{}".format(area,link_name),
		"content": content,
		"classes": classes,
	}

@register.inclusion_tag("registration/partials/link2.html")
def link2(request,area, link_name, content, classes):
	return {
		"request": request,
		"link_name": link_name,
		"link": "{}:{}".format(area,link_name),
