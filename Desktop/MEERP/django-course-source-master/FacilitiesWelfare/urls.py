...
urlpatterns = [
	...
	path('TypeProjects/CreateT/<int:pop>', TypeProjectCreate.as_view(), name="CreateTFPR"),
	...
	path('Loan/Loan-Reg-User', UserLoanReg.as_view(), name="Loan-Reg-User"),
	path('Loan/Loan-Reg-User/<int:IdLoan>', UserLoanReg.as_view(), name="Loan-Reg-User"),
	...
	path('API/Report/<int:IdUser>/<slug:DateStart>/<slug:DateEnd>', Report.as_view(), name="Report"),

	path('API/APIME', ApiTypeProject.as_view(), name="APIME"),
]